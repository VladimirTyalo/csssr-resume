...
/******/ 	var hotCurrentHash = "4a1c08c755b25829e316"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
		...
		(0, _expandingArea2.default)($about[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Slider(element) {
		var $slider = element instanceof jQuery ? element : (0, _jquery2.default)(element);
		var $knob = $slider.find('[data-slider="slider-knob"]');
		var isDragging = false;
	
		// set x coordinate of the knob when moving
		function setX(clientX) {
			var sliderOffsetLeft = $slider.offset().left;
			var positionLeft = clientX - sliderOffsetLeft - $knob.width() / 2;
			...
			if (isDragging) {
				$knob.addClass('slider__knob_scale').css('left', positionLeft);
				return;
			}
	
			// when knob moving by clicking/tapping on the slider add transition class
			// and after transitioning remove class
			_promise2.default.resolve($knob.addClass('slider__knob_move')).then(function () {
				$knob.addClass('slider__knob_move');
			}).then($knob.css('left', positionLeft)).then(function () {
				return setTimeout(function () {
					return $knob.removeClass('slider__knob_move');
				}, 500);
			}).catch(function (err) {
